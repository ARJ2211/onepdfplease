...
// TODO
// add option to do inplace decryption
...
func NewModel(ctx *context.ProgramContext) Model {
	...
	m.userInputs.ButtonText = "Decrypt and Save"
	m.fileList = lf
	m.ctx = ctx
	return m
}
...
func (m Model) Update(msg tea.Msg) (Model, tea.Cmd) {
	...
	case messages.OutputButtonClicked:
		...
		return m, utils.Decrypt(m.fileList.GetFilePaths(), password, outPath, outPrefix)
	}
